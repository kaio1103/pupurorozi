...
export const INITIAL_GREETING = 'やあ。ボクは今年の４月から北千住にやってきて、音環を見守っている猫だにゃ...。みんなからは"ひびまる"と呼ばれているんだにゃ。音環の学生生活などについて気になることがあれば、質問に答えてあげてもいいんだにゃ...。';

export const LAST_GREETING = 'おっと、そろそろ時間みたいだにゃ...。今日はありがとうにゃ。';